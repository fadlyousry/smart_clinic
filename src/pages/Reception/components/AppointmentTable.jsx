...
export const AppointmentTable = ({ filteredAppointments, isMobile, isTablet, reorderAppointments, updateAppointment, deleteAppointment }) => {
      ...
      <table className="w-full border-collapse">
        ...
        <tbody>
          {filteredAppointments.map((appt, index) => (
            <AppointmentItem key={appt.id} appt={appt} index={index} moveAppointment={moveAppointment} updateAppointment={updateAppointment} deleteAppointment={deleteAppointment} />
          ))}
        </tbody>
      </table>
    </div>
